...
<body>
    ...
    <h3 style="text-align: center;">Exam Papers</h3>
    <table>
        <thead>
            <tr> <th>S NO</th>
                <th>Subject Name</th>
        ...
        <tbody>
            <c:forEach var="examPaper" items="${examPapers}">
                <tr>
                 <td>${examPaper.id}</td>
                    <td>${examPaper.subjectName}</td>
                    <td>${examPaper.courseCode}</td>
                    <td>${examPaper.semester}</td>
                    <td>${examPaper.examDate}</td>
                    <td>
                        <!-- Provide download option -->
                        <a href="<c:url value='/downloadExamPaper?id=${examPaper.id}' />" download>
