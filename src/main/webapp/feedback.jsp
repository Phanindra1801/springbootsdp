...
<body>
    ...
    <div class="form-container">
        <form action="givefeedback" method="post" enctype="multipart/form-data">
            <table align="center">
                <tr>
                    <td><label>Faculty ID</label></td>
                    <td><input type="text" name="fid" placeholder="Enter Faculty ID" required /></td>
                </tr>

                <tr>
                    <td><label>Faculty Name</label></td>
                    <td><input type="text" name="fname" placeholder="Enter Faculty Name" required /></td>
                </tr>
				<tr>
				    <td><label>Description</label></td>
				    <td><textarea name="description" placeholder="Enter Feedback" rows="15" required></textarea></td>
				</tr>
                <tr>
