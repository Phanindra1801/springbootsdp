...
<body>
    ...
    <h3 style="text-align: center;">Add Exam Paper</h3>
    <div class="form-container">
        <form action="insertExamPaper" method="POST" enctype="multipart/form-data" class="form-container">
        <table>
            <tr>
                <td><label for="subjectName">Subject Name</label></td>
                <td><input type="text" name="subjectName" id="subjectName" required="required" /></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="date" name="examDate" id="examDate" required="required" /></td>
            </tr>
            <tr>
                <td><label for="examType">Exam Type</label></td>
                <td>
                    <select name="examType" id="examType" required="required">
                        <option value="">---Select---</option>
            ...
            <tr>
                <td><label for="questionPaperPdf">Question Paper (PDF)</label></td>
                <td><input type="file" name="questionPaperPdf" id="questionPaperPdf" accept="application/pdf" required="required" /></td>
            </tr>
            <tr align="center">
                <td colspan="2"><input type="submit" value="Add Question Paper" class="button"></td>
            </tr>
        </table>
    </form>
    </div>
